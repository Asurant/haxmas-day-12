...
const texture = new THREE.TextureLoader().load('bush1.png')
const material = new THREE.MeshBasicMaterial( {map: texture} );
const cube = new THREE.Mesh( geometry, material );
scene.add( cube );

const donut_geo = new THREE.TorusGeometry(10, 3, 16, 100);
const donut_tex = new THREE.TextureLoader().load('bush1.png')
...
function add_star(){
    ...
    const star_texture = new THREE.TextureLoader().load('bush1.png')
    const star_material = new THREE.MeshBasicMaterial( {map: star_texture} );
